...
(function (global) {
  ...
  /** V02.1 (§6, portado desde bramulab) — ¿(a,b) es un resultado FINAL válido de tie break
   *  (alguien acaba de ganar, exacto) para este objetivo? A diferencia de `isValidTiebreakScore`
   *  (que también acepta scores "en curso"), acá solo interesa un resultado ya cerrado — nunca
   *  un TB a medio jugar. Sin techo artificial: un tie break extendido (10-8, 16-14…) es tan
   *  válido como uno corto (7-0), siempre que se respete el objetivo mínimo y la diferencia de 2. */
