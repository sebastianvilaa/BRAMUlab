# Índice general — BRAMUlab

La documentación de producto vive en [`docs/`](docs/):

- [`docs/BRAMUlab/README.md`](docs/BRAMUlab/README.md) — punto de entrada: versión funcional actual (`BRAMUlab_V01`), próxima versión (`BRAMUlab_V02`), backlog, referencias y archivo histórico.
...
*Este índice reemplaza uno más largo, preservado en [`docs/BRAMUlab/Archivo/INDICE_anterior.md`](docs/BRAMUlab/Archivo/INDICE_anterior.md), de antes de que existiera el naming `BRAMUlab_V01`/`BRAMUlab_V02`.*
