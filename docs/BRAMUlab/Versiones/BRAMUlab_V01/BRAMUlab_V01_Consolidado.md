...
**Fuente:** `BRAMU_Rama_Jugador_Etapa_1_Contexto.md`
...
**Fuente:** `BRAMU_Rama_Jugador_Etapa_3_Consolidado_Producto_UX.md`
...
**Fuente:** `BRAMU_Rama_Jugador_Etapa_3_Plan_y_Reorganizacion.md` (Plan 1) y su ejecución en `BRAMU_Rama_Jugador_Etapa_3_Fase_0_Informe.md`
...
**Fuente:** `BRAMU_Rama_Jugador_Etapa_2_Home_Beta.md`
...
**Fuentes:** `BRAMU_Rama_Jugador_Auditoria_Funcional.md` (auditoría) y `BRAMU_Rama_Jugador_Correccion_Funcional.md` (corrección)
...
**Fuente:** `BRAMU_Lab_Etapa_4_v2_Experiencia_Integral_Consolidado.md`
...
**Fuente:** informe únicamente, sin consolidado separado — ver `BRAMU_Lab_v1.3.1_Hotfix_Transicion_Post_Guardado_Informe.md`. Reaccionaba a una revisión externa (ChatGPT) de v1.3 en producción: reabrir una celda de set ya cargada dejaba el teclado numérico abierto y tapando el Resumen tras guardar.

---

## 8. Etapa 4.1 — Historial y evolución (v2.1)

**Fuente:** `BRAMU_Lab_Etapa_4_1_v2_1_Historial_y_Evolucion_Consolidado.md` + guía de datos simulados en `BRAMU_Lab_v2_Prueba_Guiada_Datos_Simulados.md`
...
**Fuente:** `BRAMU_Lab_Etapa_4_2_v2_2_Carga_Manual_y_Jerarquia_Consolidado.md`
