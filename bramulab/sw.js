...
// bump de bundle (APP_VERSION sigue en "BRAMUlab V04.11" a propósito).
// Ronda correctiva (revisión central, mismo día) — `-h3`: diff antes/después de una corrección
// (get_match_detail.previousRevisionSets/pendingCorrectionSets) + fix de RECIENTES incluyendo
// provisionales. Mismo criterio: solo bump de bundle.
// Revisión central final (mismo día) — `-h4`: clasificación real de evento en partidos pending
...
// provisionales. Mismo criterio: solo bump de bundle.
const CACHE_NAME = 'bramulab-v04-11-h6';
...
const CORE_ASSETS = [
  './',
  './index.html',
  './styles.css?v=04.11-h6',
  './engine.js?v=04.11-h6',
  './stats.js?v=04.11-h6',
  './store.js?v=04.11-h6',
  ...
  './level.js?v=04.11-h6',
  './level-context.js?v=04.11-h6',
  './level-calibration.js?v=04.11-h6',
  './player-home.js?v=04.11-h6',
  './match-load.js?v=04.11-h6',
  './player-identity.js?v=04.11-h6',
  './groups.js?v=04.11-h6',
  './locations.js?v=04.11-h6',
  './ranking.js?v=04.11-h6',
